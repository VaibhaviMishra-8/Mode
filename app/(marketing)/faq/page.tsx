    ...
    <div className="container mx-auto px-4 py-12 text-white">
      ...
      <div className="space-y-6">
        <FAQItem
          ...
          answer="Mode is a project management tool. It helps teams organize, track, and manage their projects and issues in a simple and efficient way."
        />
        ...
        <FAQItem
          ...
          answer="Yes, Mode is completely free to use."
        />
